...
const SemesterDetails = () => {
  const columns = [
    ...
    { label: 'Valid From', key: 'from' },
    { label: 'Valid To', key: 'to' },
  ...
  const data = [
    { name: "HCT 1", from: "Apr", to: "Sep", status: <span className="text-emerald-600 font-black">Active</span>, updated: "06-04-2026 01:32 PM",
    ...
    { name: "VI", from: "Oct", to: "Jan", status: <span className="text-emerald-600 font-black">Active</span>, updated: "12-06-2024 10:37 AM",
      action: <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><Edit size={16} /></button>
    },
  ];
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-1">Semester Details</h1>
            <p className="text-slate-500 font-medium tracking-wide">Manage academic terms and valid date ranges.</p>
          </div>
        </div>
      ...
      <ProfessionalTable title="Semester Information" data={data} columns={columns} />
    </div>
  );
};
