...
const BloodGroupManagement = () => {
  ...
  const data = [
    { name: "O-", status: <span className="text-emerald-600 font-black">Active</span>, updated: "13-10-2023 07:26 PM",
    ...
    { name: "AB-", status: <span className="text-emerald-600 font-black">Active</span>, updated: "13-11-2022 05:32 AM",
      action: <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><Edit size={16} /></button>
    },
    { name: "O+", status: <span className="text-emerald-600 font-black">Active</span>, updated: "13-11-2022 05:32 AM",
      action: <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><Edit size={16} /></button>
    },
  ];
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-1">Blood Group Details</h1>
            <p className="text-slate-500 font-medium tracking-wide">Manage global blood group categories for student and faculty records.</p>
          </div>
        </div>
      ...
      <ProfessionalTable title="Blood Group Overiew" data={data} columns={columns} />
    </div>
  );
};
