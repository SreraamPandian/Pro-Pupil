...
const StateDetails = () => {
  ...
  const data = [
    { name: "Abu Dhabi", status: <span className="text-emerald-600 font-black">Active</span>, updated: "03-06-2024 05:28 PM",
    ...
    { name: "Dubai", status: <span className="text-emerald-600 font-black">Active</span>, updated: "19-09-2022 01:21 PM",
      action: <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><Edit size={16} /></button>
    },
    { name: "Sharjah", status: <span className="text-emerald-600 font-black">Active</span>, updated: "19-09-2022 01:21 PM",
      action: <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><Edit size={16} /></button>
    },
  ];
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-1">Emirate Details</h1>
            <p className="text-slate-500 font-medium tracking-wide">Manage primary emirates and territories for U.A.E mapping.</p>
          </div>
        </div>
      ...
      <ProfessionalTable title="State Overview" data={data} columns={columns} />
    </div>
  );
};
