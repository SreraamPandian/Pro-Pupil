...
import { Calendar, Search, Table as TableIcon, CheckCircle, Clock, BookOpen } from 'lucide-react';
...
const OverallTimeslot = () => {
  ...
  const data = [
    { 
      year: "2026-27", semester: "HCT 1", day: "Tuesday", status: <span className="text-slate-400 font-bold">In Active</span>, updated: "14-04-2026 11:56 AM",
      action: (
    ...
    { 
      year: "2026-27", semester: "HCT 1", day: "Monday", status: <span className="text-slate-400 font-bold">In Active</span>, updated: "14-04-2026 12:03 AM",
      action: (
        <div className="flex items-center gap-2">
          <button className="p-2 bg-orange-500 text-white rounded-xl shadow-lg shadow-orange-100 hover:scale-110 active:scale-90 transition-all"><TableIcon size={16} /></button>
          <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><CheckCircle size={16} /></button>
    ...
    { 
        year: "2026-27", semester: "HCT 1", day: "Saturday", status: <span className="text-emerald-600 font-black">Active</span>, updated: "11-04-2026 01:24 PM",
        action: (
          <div className="flex items-center gap-2">
            <button className="p-2 bg-orange-500 text-white rounded-xl shadow-lg shadow-orange-100 hover:scale-110 active:scale-90 transition-all"><TableIcon size={16} /></button>
            <button className="p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-100 hover:scale-110 active:scale-90 transition-all"><CheckCircle size={16} /></button>
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center gap-5">
        ...
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-1">Overall Timeslot Details</h1>
          <p className="text-slate-500 font-medium tracking-wide">High-level overview of timeslots across semesters and days.</p>
        </div>
      </div>
      ...
      <ProfessionalTable title="Overall Timeslot Schedule" data={data} columns={columns} />
    </div>
  );
};

export default OverallTimeslot;
